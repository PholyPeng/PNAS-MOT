...
specified in writeLabels.m. Additionally a 18'th value must be provided
...
CLEARMOT and Mostly-Tracked/Partly-Tracked/Mostly-Lost metrics.
...
Evaluation on KITTI for Tracking and MOTS now uses the TrackEval codebase (https://github.com/JonathonLuiten/TrackEval).


Old code:
================

For transparency we have included the previously used KITTI evaluation code in the
subfolder 'python' of this development kit.

You probably need to install the python-munkres package using 
pip (Pip Installs Python). 

The script assumes the ground truth data to be in ./data/tracking/label_02 and 
the tracker data in ./results/<sha_key>/data.

Results are created by executing
$> ./evaluate_tracking.py <sha_key>
