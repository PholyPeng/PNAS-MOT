...
OPS = {
    ...
    'skip_connect': lambda C_in, C_out, stride, affine: Identity() if stride == 1 else FactorizedReduce(C_in, C_out,
                                                                                                        affine=affine),
    ...
    'conv_7x1_1x7': lambda C_in, C_middle, C_out, stride, affine: nn.Sequential(
        nn.ReLU(inplace=False),
        nn.Conv2d(C_in, C_middle, (1, 7), stride=(1, stride), padding=(0, 3), bias=False),
        nn.Conv2d(C_middle, C_out, (7, 1), stride=(stride, 1), padding=(3, 0), bias=False),
